...
<div class="middle-box text-center loginscreen animated fadeInDown">
    <div>
        ...
        <p> <strong>Login as a Student.</strong> </p>
            <form class="m-t" role="form" action="{{route('student-auth')}}" method="POST">
                @csrf
                ...
                <a class="btn btn-sm btn-white btn-block" href="{{ route('student-register') }}">Register</a>
            </form>
